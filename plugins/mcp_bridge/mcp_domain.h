...
struct Text { QString content; QPointF position; double size; QString font = "standard"; };
struct MText { QString content; QPointF position; double height; double angle; QString font = "standard"; };
